        ...
        return (
          <div key={booking.id} className="relative">
            <div className="flex items-center gap-3 mb-3">
              <span className={`px-2 py-0.5 text-[10px] rounded-full font-medium border ${statusColor(booking.status)}`}>{booking.status}</span>
                ...
                <div key={i} className="relative">
                  ...
                  <div className="bg-dark-700/30 rounded-lg p-3 border border-white/5">
                    <div className="flex items-center justify-between mb-1">
                      ...
                      <p className="text-[10px] text-slate-500">{formatDate(ev.date)}</p>
                    </div>
